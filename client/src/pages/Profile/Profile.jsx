      ...
      <div className="profile-container">
        ...
        <div className="profile-details">
          <div className="w-1/2 float-left mr-4">
            <div className="about-section bg-gray-800 p-4 rounded h-1/2 font-semibold text-gold mt-2">
              <h2>About</h2>
              <div className="email mt-4">EMAIL: {data?.email}</div>
              <div className="age mt-4">Age: {data?.age}</div>
              <div className="location mt-4">Location: {data?.address}</div>
              <div className="gender mt-4">Gender: {data?.gender}</div>
              <div className="Profession mt-4">Profession: {data?.prof}</div>
