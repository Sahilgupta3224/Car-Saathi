            ...
            <div className='w-fullpy-auto px-4' style={{ height: '80vh' }}>
                <div className='max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 items-center'>
                    <div className='text-center md:text-left px-10'>
                        ...
                        <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2 font-serif text-justify '>Manage Data Analytics</h1>
                        <p className='text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde fugit fugiat sit quia voluptatibus corrupti itaque repellat eligendi. Quibusdam numquam esse minus ducimus corporis nulla repellendus vitae perspiciatis itaque aperiam!</p>
